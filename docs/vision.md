...
| 2026-06-22 | **Summary shape**: outcome-oriented — `Gist / Key points / Outcome / Next`. Favor concrete findings, decisions, and follow-ups over a table of contents; dropped "Started" (redundant with the title) and promoted next-actions to their own line. (Resolves the open question below.) |
